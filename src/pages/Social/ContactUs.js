            ...
            <div className="container">
              <div className="text-center">
                ...
                <h1 className="mb-20 wow fadeIn animated font-xxl fw-900">
                  Let's Talk About <br />
                  Your <span className="text-style-1">Idea</span>
                </h1>
            ...
            <div className="row">
              <div className="col-md-4 mb-4 mb-md-0">
                ...
                <a
                  ...
                  data-cfemail="02616d6c766361764247746370632c616d6f"
                >
                  [email&#160;protected]
                </a>
                <br />
              ...
              <div className="col-md-4 mb-4 mb-md-0">
                ...
                <a
                  href="http://wp.alithemes.com/cdn-cgi/l/email-protection"
                  className="__cf_email__"
                  data-cfemail="27444849534644536762514655460944484a"
                >
                  [email&#160;protected]
                </a>
                <br />
              ...
              <div className="col-md-4">
                ...
                <a
                  href="http://wp.alithemes.com/cdn-cgi/l/email-protection"
                  className="__cf_email__"
                  data-cfemail="c2a1adacb6a3a1b68287b4a3b0a3eca1adaf"
                >
                  [email&#160;protected]
                </a>
                <br />
